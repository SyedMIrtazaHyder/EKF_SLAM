...
def generate_launch_description():
  ...
  world_file_name = 'basic_mobile_bot_world/customWorld.world'
  world_path = os.path.join(pkg_share, 'worlds', world_file_name)
  nav2_dir = FindPackageShare(package='nav2_bringup').find('nav2_bringup') 
  nav2_launch_dir = os.path.join(nav2_dir, 'launch') 
  static_map_path = os.path.join(pkg_share, 'maps', 'smalltown_world.yaml')
  nav2_params_path = os.path.join(pkg_share, 'params', 'nav2_params_all.yaml')
  ...
  start_ros2_navigation_cmd = IncludeLaunchDescription(
    ...
    launch_arguments = {'namespace': namespace,
                        ...
                        'autostart': autostart}.items()) #changing autostart to true
